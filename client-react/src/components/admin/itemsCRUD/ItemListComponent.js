...
function ItemList() {
    ...
    async function delete_item(id){
        await axios.delete(`https://first-try-heroku-deployment.herokuapp.com/api/items/${id}`)
        alert("Item Deleted from DB");
        console.log(`https://first-try-heroku-deployment.herokuapp.com/api/items/${id}`)
