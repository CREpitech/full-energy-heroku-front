...
function UpdateItem(props) {
    ...
    async function get_itemInfo() {
        ...
        await axios.get(`https://first-try-heroku-deployment.herokuapp.com/api/items/${id}`)
            .then(res => {
                const data = res.data;
    ...
    async function update_item(id, item) {
        await axios.put(`https://first-try-heroku-deployment.herokuapp.com/api/items/${id}`, {
            title: item.title,
