...
function Microservices() {
    ...
    async function get_users(){
        await axios.get("https://first-try-heroku-deployment.herokuapp.com/api/users")
        .then(res=>{
            const data = res.data;
            console.log(data)
    ...
    async function get_items(){
        await axios.get("https://first-try-heroku-deployment.herokuapp.com/api/items")
        .then(res=>{
            const data = res.data;
            console.log(data)
            const len = data.length;
    ...
    async function get_carts(){
        await axios.get("https://first-try-heroku-deployment.herokuapp.com/api/carts")
        .then(res=>{
            const data = res.data;
            console.log(data)
            const len = data.length;
    ...
    async function get_orders(){
        await axios.get('https://first-try-heroku-deployment.herokuapp.com/api/order')
            .then(res=>{
                const data = res.data;
