...
function UpdateUser(props) {
    ...
    async function get_userInfo(){
        ...
        await axios.get(`https://first-try-heroku-deployment.herokuapp.com/api/users/${id}`)
        .then(res=>{
            const data = res.data;
    ...
    async function update_user(id, user) {
        await axios.put(`https://first-try-heroku-deployment.herokuapp.com/api/users/${id}`, {
            name: user.name,
